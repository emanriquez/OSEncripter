...
+ (NSString *) encriptarTexto:(NSString*)texto :(NSString*)clave_privada
{
    NSDate *now = [NSDate date];
    NSString *strDate = [[NSString alloc] initWithFormat:@"%@",now];
    NSArray *arr = [strDate componentsSeparatedByString:@" "];
    NSString *str; str = [arr objectAtIndex:0];
    NSString* secret_key =clave_privada;
    NSString* secret_iv = [NSString stringWithFormat:@"%@",str]; //ENVIAMOS FECHA YYY-MM-DD
